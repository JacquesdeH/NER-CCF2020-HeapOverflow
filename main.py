...
if __name__ == '__main__':
    ...
    print("Monitor: Data processing begin !")
    
    data_process = CCF2020DataProcess(config.data)
    
    print("Monitor: Done data processing !")
    if en_prep:
        clue.conv2json()
        ccf2020.conv2json()
        w2v.conv2pkl()
